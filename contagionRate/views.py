...
def index(request):
  ...
  ax.set_title('[ Contagion Rate - 3-day: ' + str(current_sickRate) + ' 1-day: ' + str(round(day_by_day_sickRate,2)) + ' ]  [ In 30 days, total of: ' + f'{round(future_sick):,}' + ' (+ ' + round(float(future_sick) - float(current_sick)) + ')  sick ]  [ Number of sick multiplies every ' + str(total_mult_days) + ' days ]')
